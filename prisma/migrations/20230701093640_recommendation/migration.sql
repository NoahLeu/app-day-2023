/*
  ...
  - Made the column `userLocationId` on table `User` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_User" ("activeChallengeId", "challenge_score", "email", "emailVerified", "id", "image", "password", "userLocationId", "username") SELECT "activeChallengeId", "challenge_score", "email", "emailVerified", "id", "image", "password", "userLocationId", "username" FROM "User";
DROP TABLE "User";
